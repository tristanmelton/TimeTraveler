...
public class EntityXPOrbTT extends Entity
{
    /**
    ...
    public EntityXPOrbTT(World par1World, double par2, double par4, double par6, int par8)
    {
        super(par1World);
    ...
    public EntityXPOrbTT(World par1World)
    {
        super(par1World);
    ...
    public void setXpValue(int xpVal)
    {
    	this.xpValue = xpVal;
    }
    /**
