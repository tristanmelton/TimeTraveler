...
public class RenderCondenser extends TileEntitySpecialRenderer
{
   ...
   {
      renderCondenserTileEntityAt(d0,d1,d2,f);
      
   }
   private void renderCondenserTileEntityAt(double d, double d1, double d2, float f)
   {
	 /*  int i = 0;
      ...
      if(te.worldObj != null) 
      {
         i = (te.worldObj.getBlockMetadata(te.xCoord, te.yCoord, te.zCoord)); 
   		...
   		ResourceLocation texture = new ResourceLocation("charsmud_timetraveler", "textures/blocks/ParadoxCondenser.png");
