...
public class TeleporterTime extends Teleporter
{
 ...
 private final List field_85190_d = new ArrayList();
  ...
  public TeleporterTime(WorldServer par1WorldServer)
 {
 ...
 public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
 {
  ...
  else
  {
   for (var48 = var15 - var9; var48 <= var15 + var9; ++var48)
   {
     ...
     for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23)
    {
     ...
     {
      if (this.field_85192_a.getBlockId(var48, var26, var23) == TimeTraveler.timePortal.blockID)
      {
       while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == TimeTraveler.timePortal.blockID)
       {
        --var26;
       }
   ...
   if (var10 >= 0.0D)
  {
   ...
   int var50 = -1;
    ...
    if (this.field_85192_a.getBlockId(var12 - 1, var13, var14) == TimeTraveler.timePortal.blockID)
   {
    var50 = 2;
   }
    ...
    if (this.field_85192_a.getBlockId(var12 + 1, var13, var14) == TimeTraveler.timePortal.blockID)
   {
    ...
    if (this.field_85192_a.getBlockId(var12, var13, var14 - 1) == TimeTraveler.timePortal.blockID)
   {
    var50 = 3;
   }
    ...
    if (this.field_85192_a.getBlockId(var12, var13, var14 + 1) == TimeTraveler.timePortal.blockID)
   {
    ...
    int var30 = par1Entity.func_82143_as();

    if (var50 > -1)
   {
    int var31 = Direction.directionToFacing[var50];
    ...
    boolean var37 = !this.field_85192_a.isAirBlock(var12 + var32, var13, var14 + var33) || !this.field_85192_a.isAirBlock(var12 + var32, var13 + 1, var14 + var33);
     ...
     if (var36 && var37)
    {
     var50 = Direction.directionToFacing[var50];
     var31 = Direction.directionToFacing[var31];
    ...
    else if (var50 == Direction.directionToFacing[var30])
    {
     var40 = -1.0F;
     var41 = -1.0F;
    }
  ...
  // this.field_85192_a.editingBlocks = true;
    ...
    for (var20 = 0; var20 < 4; ++var20)
   {
    for (var21 = -1; var21 < 4; ++var21)
    {
     ...
     this.field_85192_a.setBlock(var22, var23, var24, var33 ? Block.sandStone.blockID : TimeTraveler.timePortal.blockID);
    }
   }
